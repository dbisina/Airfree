...
export const SERVICES = [
  { image: '/images/gisinfra.jpg', slug: 'gis-spatial', number: '01', title: 'Enterprise GIS & Spatial Infrastructure Systems', shortTitle: 'GIS & Spatial Infrastructure', description: 'Design, deployment and management of enterprise-grade spatial data infrastructure. PostGIS database architecture, GIS server deployment, and end-to-end spatial data lifecycle management.', tags: ['PostGIS', 'GeoServer', 'SDI Frameworks', 'ArcGIS Server', 'INSPIRE'] },
  { image: '/images/digitalmap.png', slug: 'digital-mapping', number: '02', title: 'Digital Mapping & Web GIS Platforms', shortTitle: 'Digital Mapping & Web GIS', description: 'Development and deployment of interactive web-based GIS platforms and geospatial dashboards for institutional decision-support environments.', tags: ['Leaflet.js', 'OpenLayers', 'ArcGIS Online', 'MapBox GL', 'GeoNode'] },
  { image: '/images/dronemap.png', slug: 'drone-photogrammetry', number: '03', title: 'Drone, Photogrammetry & 3D Spatial Engineering', shortTitle: 'Drone & Photogrammetry', description: 'End-to-end UAV survey operations and photogrammetric processing workflows. Point cloud generation, 3D mesh modelling, and volumetric analysis.', tags: ['Agisoft Metashape', 'Pix4D', 'DJI Terra', 'CloudCompare', 'LiDAR'] },
  { image: '/images/digitalmap.png', slug: 'remote-sensing', number: '04', title: 'Remote Sensing & Satellite Analytics', shortTitle: 'Remote Sensing & AI', description: 'Satellite imagery analysis, multispectral classification, change detection, and ML-driven land analysis across large geographic extents.', tags: ['ENVI', 'Google Earth Engine', 'Sentinel Hub', 'GDAL', 'Python'] },
  { image: '/images/gisinfra.jpg', slug: 'infrastructure-utility', number: '05', title: 'Infrastructure & Utility Spatial Systems', shortTitle: 'Infrastructure & Utilities', description: 'Geospatial systems for utility networks, asset registers, and infrastructure planning. Network tracing and maintenance GIS for water, gas, and electricity operators.', tags: ['Esri Utility Network', 'OpenStreetMap', 'QGIS', 'Network Analysis', 'AM/FM'] },
  { image: '/images/gisinfra.jpg', slug: 'survey-data', number: '06', title: 'Survey Data QA/QC & Spatial Standards', shortTitle: 'Survey Data & QA/QC', description: 'Quality assurance and standards compliance for surveyed spatial data. ISO 19100, ICSM, and ANZLIC-aligned data validation and metadata management.', tags: ['ICSM', 'ISO 19100', 'FME', 'QGIS', 'Python'] },
  { image: '/images/dronemap.png', slug: 'environmental', number: '07', title: 'Environmental & Ecological Geospatial Analytics', shortTitle: 'Environmental Intelligence', description: 'Spatial analytics for environmental monitoring, ecological mapping, and carbon accounting across regulated and natural environments.', tags: ['Google Earth Engine', 'ENVI', 'TerrSet', 'ArcGIS Pro', 'Python'] },
];
