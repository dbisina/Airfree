...
export const CMS_DEFAULTS: CMSContent = {
  ...
  hero: {
    slides: [
      { id: 'slide-1', photo: 'https://images.unsplash.com/photo-1446776811953-b23d57bd21aa?w=1920&q=80', label: 'Enterprise Spatial Intelligence', heading: 'AIRFREE\nGEOSPATIAL', body: 'Delivering mission-critical geospatial solutions for government authorities, utility networks, and large-scale engineering operations across Australia.', cta_primary: 'View Capabilities', cta_secondary: 'Request Capability Statement' },
