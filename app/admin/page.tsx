...
const DEFAULTS: CMSContent = {
  ...
  page_photos: {
    ...
    industries:
      "https://images.unsplash.com/photo-1519608487953-e999c86e7455?w=1600&q=80",
    products:
      "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1600&q=80",
    projects:
      "https://images.unsplash.com/photo-1569396116180-210c182bedb8?w=1600&q=80",
    technology:
      "https://images.unsplash.com/photo-1579829366248-204fe8413f31?w=1600&q=80",
  },
  about_intro: {
...
function PhotoField({
  ...
  return (
    <div className="mb-5" suppressHydrationWarning>
      ...
      {value && (
        <div
          className={`${height} relative overflow-hidden border border-black/[0.06] mb-2`}
        >
...
function SectionHeading({
  ...
  return (
    <div className="mb-6 pb-5 border-b border-black/[0.06]">
      <h2 className="font-serif text-lg text-black font-medium mb-1">
        {title}
      </h2>
          ...
          <div className="grid grid-cols-2 gap-x-5 mb-3">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  updateSlide(slide.id, "cta_primary", e.target.value)
                }
                className={INPUT_CLS}
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  updateSlide(slide.id, "cta_secondary", e.target.value)
                }
                className={INPUT_CLS}
              />
            </div>
...
const PAGE_PHOTO_LABELS: Array<{
  key: keyof CMSContent["page_photos"];
  label: string;
}> = [
        ...
        <div key={city} className="mb-8 last:mb-0">
          ...
          <div className="grid grid-cols-2 gap-x-5">
            ...
            <Field
              ...
              onChange={(v) =>
                handleChange(`locations.${city}.address_line1`, v)
              }
            />
            <Field
              ...
              onChange={(v) =>
                handleChange(`locations.${city}.address_line2`, v)
              }
            />
          </div>
          <Field
      ...
      <div className="mb-10">
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="font-mono text-[0.7rem] text-[#4A86B8]">
              {content.typography.body_size}px
            </span>
          </div>
          <input
            type="range"
          ...
          <div className="flex justify-between mt-1">
            <span className="font-mono text-[0.55rem] text-black/25">
              14px — Compact
            </span>
            <span className="font-mono text-[0.55rem] text-black/25">
              24px — Large
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="font-mono text-[0.7rem] text-[#4A86B8]">
              {content.typography.heading_size || 100}%
            </span>
          </div>
          <input
            type="range"
            ...
            onChange={(e) =>
              handleNumber("heading_size", Number(e.target.value))
            }
            className="w-full accent-[#4A86B8] cursor-pointer"
          />
          <div className="flex justify-between mt-1">
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="font-mono text-[0.7rem] text-[#4A86B8]">
              {content.typography.nav_size || 100}%
            </span>
          </div>
          <input
            type="range"
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="font-mono text-[0.7rem] text-[#4A86B8]">
              {content.typography.button_size || 100}%
            </span>
          </div>
          <input
            type="range"
            ...
            onChange={(e) =>
              handleNumber("button_size", Number(e.target.value))
            }
            className="w-full accent-[#4A86B8] cursor-pointer"
          />
          <div className="flex justify-between mt-1">
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="font-mono text-[0.7rem] text-[#4A86B8]">
              {content.typography.label_size || 100}%
            </span>
          </div>
          <input
            type="range"
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-col gap-3 mt-2">
            {HEADING_FONT_OPTIONS.map((font) => (
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <span className="font-mono text-[0.55rem] tracking-widest uppercase text-black/40">
                    {font.name}
                  </span>
                  {content.typography.heading_font === font.id && (
                    <span className="font-mono text-[0.5rem] tracking-widest uppercase text-[#4A86B8]">
                      Active
                    </span>
                  )}
                </div>
                ...
                <p className="text-black/35 text-[0.65rem] mt-1.5">
                  {font.desc}
                </p>
              </button>
            ))}
      ...
      <div className="mb-6">
        ...
        <div className="mb-5">
          ...
          <select
            ...
            onChange={(e) =>
              handleChange("typography.nav_font_target", e.target.value)
            }
            className={INPUT_CLS}
          >
            <option value="sans">
              Sans-Serif Family (Body font selection)
            </option>
        ...
        <div className="mb-5">
          ...
          <select
            ...
            onChange={(e) =>
              handleChange("typography.button_font_target", e.target.value)
            }
            className={INPUT_CLS}
          >
            <option value="sans">
        ...
        <div className="mb-5">
          ...
          <select
            ...
            onChange={(e) =>
              handleChange("typography.label_font_target", e.target.value)
            }
            className={INPUT_CLS}
          >
            <option value="sans">
  ...
  if (!mounted || checkingAuth) {
    return (
      <div className="h-screen flex items-center justify-center bg-[#F7F7F5]">
        <div className="font-serif text-sm text-black/40 animate-pulse">
    ...
    <div className="h-screen flex flex-col overflow-hidden bg-[#F7F7F5]">
      ...
      <header className="shrink-0 bg-white border-b border-black/[0.06] px-6 py-3 flex items-center justify-between z-20">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={() =>
              window.open("https://airfreegeospatial.com.au", "_blank")
            }
            className="text-xs px-3 py-1.5 border border-black/20 text-black/50 hover:text-black/80 hover:border-black/40 rounded-[2px] transition-colors"
          >
            Live Site ↗
              ...
              {historyOpen && (
                <div className="max-h-64 overflow-y-auto border-t border-black/[0.06]">
                  {historyEntries.length === 0 ? (
                    <p className="px-5 py-4 text-black/30 text-xs">
                    ...
                    historyEntries.map((entry) => (
                      <div
                        key={entry.timestamp}
                        className="px-5 py-3 border-b border-black/[0.04] flex flex-col gap-1"
                      >
              ...
              >
                ...
                >
                  <iframe
                    ...
                    onLoad={() => {
                      try {
                        const d = laptopRef.current?.contentDocument;
                        if (d) {
            ...
            >
              ...
              >
                <iframe
                  ...
                  onLoad={() => {
                    try {
                      const d = phoneRef.current?.contentDocument;
                      if (d) {
                        const s = d.createElement("style");
                        s.textContent =
                          "::-webkit-scrollbar{display:none}*{scrollbar-width:none;-ms-overflow-style:none}";
