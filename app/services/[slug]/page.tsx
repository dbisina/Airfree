...
> = {
  'gis-spatial': {
    ...
    standards: ['OGC WMS/WFS/WCS', 'ISO 19100 Series', 'ANZLIC', 'ICSM', 'INSPIRE'],
  },
  'digital-mapping': {
    overview:
  ...
  'infrastructure-utility': {
    ...
    standards: ['Esri Utility Network', 'OGC Standards', 'Australian Infrastructure Regulations'],
  },
  'survey-data': {
    overview:
    ...
    standards: ['ISO 19100 Series', 'ICSM Survey Practice', 'ANZLIC Metadata Profile', 'GDA2020'],
  },
  'environmental': {
    overview:
    ...
    standards: ['EPBC Act', 'ERF Methodology', 'State Native Vegetation Acts', 'ISO 19157'],
  },
};
            ...
            {detail.solutions.map((solution, i) => (
              <RevealOnScroll key={solution.title} delay={i * 0.08}>
                <div className="bg-white border border-border-s p-5 sm:p-7 h-full">
                  ...
                  <p className="text-ink-2 leading-relaxed" style={{ fontSize: '0.875rem' }}>
        ...
        <div className="max-w-7xl mx-auto px-8 md:px-16 lg:px-24 text-center">
          <RevealOnScroll>
            ...
            <p className="text-ink-2 mb-8 max-w-md mx-auto" style={{ fontSize: '0.95rem' }}>
              Contact our team to discuss your project requirements and receive a tailored capability statement for procurement purposes.
            </p>
